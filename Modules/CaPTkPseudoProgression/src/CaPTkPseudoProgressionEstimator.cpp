...
#include "CaPTkPseudoProgressionEstimator.h"
...
captk::PseudoProgressionEstimator::PseudoProgressionEstimator()
{
...
ImageTypeFloat3D::Pointer captk::PseudoProgressionEstimator::RescaleImageIntensity(ImageTypeFloat3D::Pointer image)
{
...
bool captk::PseudoProgressionEstimator::TrainNewModelOnGivenData(const std::vector<std::map<CAPTK::ImageModalityType, std::string>> qualifiedsubjects, const std::string &outputdirectory, bool useConventionalData, bool useDTIData, bool usePerfData, bool useDistData)
{
    ...
    std::cout << std::endl
              << "Model saved to the output directory." << std::endl;
...
int captk::PseudoProgressionEstimator::GetFeatureVectorSize(bool &useConventionalData, bool &useDTIData, bool &usePerfData, bool &useDistData)
{
    int size = 0;
...
bool captk::PseudoProgressionEstimator::PseudoProgressionEstimateOnExistingModel(std::vector<std::map<CAPTK::ImageModalityType, std::string>> qualifiedsubjects,
...
VariableLengthVectorType captk::PseudoProgressionEstimator::DistanceFunction(const VariableSizeMatrixType &testData, const std::string &filename, const double &rho, const double &bestg)
{
...
VariableSizeMatrixType captk::PseudoProgressionEstimator::LoadPseudoProgressionTestingData(const std::vector<std::map<CAPTK::ImageModalityType, std::string>> &testingsubjects, std::vector<double> &testinglabels, std::string outputdirectory, std::string modeldirectory)
{
...
VariableSizeMatrixType captk::PseudoProgressionEstimator::LoadPseudoProgressionTrainingData(const std::vector<std::map<CAPTK::ImageModalityType, std::string>> &trainingsubjects, std::vector<double> &traininglabels, std::string outputdirectory)
{
    VariableSizeMatrixType FeaturesOfAllSubjects;
...
PerfusionMapType captk::PseudoProgressionEstimator::CombineAndCalculatePerfusionPCA(PerfusionMapType PerfusionDataMap, VariableSizeMatrixType &TransformationMatrix, VariableLengthVectorType &MeanVector)
{
...
PerfusionMapType captk::PseudoProgressionEstimator::CombineAndCalculatePerfusionPCAForTestData(PerfusionMapType PerfusionDataMap, VariableSizeMatrixType &TransformationMatrix, VariableLengthVectorType &MeanVector)
{
    PerfusionMapType RevisedPerfusionMap;
...
PerfusionMapType captk::PseudoProgressionEstimator::CombinePerfusionDataAndApplyExistingPerfusionModel(PerfusionMapType PerfusionDataMap, VariableSizeMatrixType TransformationMatrix, VariableLengthVectorType MeanVector)
{
    PerfusionMapType RevisedPerfusionMap;
...
VectorDouble captk::PseudoProgressionEstimator::GetIntensityFeatures(std::vector<float> m_nonZeroPixels)
{
...
VectorDouble captk::PseudoProgressionEstimator::GetHistogramFeatures(std::vector<float> intensities, int m_Bins)
{
    std::vector<double> features;
...
VectorDouble captk::PseudoProgressionEstimator::GetHistogramFeaturesWhole(std::vector<float> intensities)
{
...
VectorVectorDouble captk::PseudoProgressionEstimator::CombineAllThePerfusionFeaures(VectorVectorDouble T1IntensityHistogram,
                                                                             VectorVectorDouble TCIntensityHistogram,
                                                                             VectorVectorDouble T1TCIntensityHistogram,
                                                                             VectorVectorDouble T2IntensityHistogram,
                                                                             VectorVectorDouble FLIntensityHistogram,
...
VariableSizeMatrixType captk::PseudoProgressionEstimator::ColumnWiseScaling(VariableSizeMatrixType inputdata)
{
...
VariableSizeMatrixType captk::PseudoProgressionEstimator::SelectModelFeatures(const VariableSizeMatrixType &ModelFeatures)
{
...
VectorDouble captk::PseudoProgressionEstimator::EffectSizeFeatureSelection(const VariableSizeMatrixType training_features, std::vector<double> target)
{
    //make set 1and set2
    int NoOfSamplesC1 = 0;
    int NoOfSamplesC2 = 0;
...
template <typename T>
std::vector<size_t> captk::PseudoProgressionEstimator::sort_indexes(const std::vector<T> &v)
{
...
VectorDouble captk::PseudoProgressionEstimator::CombineEstimates(const VariableLengthVectorType &estimates1, const VariableLengthVectorType &estimates2)
{
...
void captk::PseudoProgressionEstimator::WritePCAOutputs(std::string suffix, std::string outputdirectory, const VariableLengthVectorType mean, const VariableSizeMatrixType coefs)
{
    std::ofstream myfile;
...
void captk::PseudoProgressionEstimator::ReadAllTheModelParameters(std::string modeldirectory,
                                                           VariableSizeMatrixType &PCA_PERF,
                                                           VariableSizeMatrixType &PCA_T1,
                                                           VariableSizeMatrixType &PCA_T1CE,
                                                           VariableSizeMatrixType &PCA_T2,
...
void captk::PseudoProgressionEstimator::WriteCSVFiles(VariableSizeMatrixType inputdata, std::string filepath)
{
    std::ofstream myfile;
...
void captk::PseudoProgressionEstimator::WriteCSVFiles(VectorVectorDouble inputdata, std::string filepath)
{
    std::ofstream myfile;
    myfile.open(filepath);
...
void captk::PseudoProgressionEstimator::WriteCSVFiles(vtkSmartPointer<vtkTable> inputdata, std::string filepath)
{
    std::ofstream myfile;
    myfile.open(filepath);
...
void captk::PseudoProgressionEstimator::WriteCSVFiles(VariableLengthVectorType inputdata, std::string filepath)
{
    std::ofstream myfile;
    myfile.open(filepath);
    for (unsigned int index1 = 0; index1 < inputdata.Size(); index1++)
...
void captk::PseudoProgressionEstimator::WriteCSVFiles(std::vector<double> inputdata, std::string filepath)
{
    std::ofstream myfile;
    myfile.open(filepath);
    for (unsigned int index1 = 0; index1 < inputdata.size(); index1++)
...
VariableSizeMatrixType captk::PseudoProgressionEstimator::GetModelSelectedFeatures(VariableSizeMatrixType &ScaledFeatureSetAfterAddingLabel, VariableLengthVectorType &SelectedFeatures)
{
...
vtkSmartPointer<vtkTable> captk::PseudoProgressionEstimator::MakePCAMatrix(int NumberOfFeatures, int NumberOfSamples)
{
