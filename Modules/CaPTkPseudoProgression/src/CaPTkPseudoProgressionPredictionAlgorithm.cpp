...
captk::PseudoProgressionPredictionAlgorithm::~PseudoProgressionEstimator()
{
...
ImageTypeFloat3D::Pointer captk::PseudoProgressionPredictionAlgorithm::RescaleImageIntensity(ImageTypeFloat3D::Pointer image)
{
...
bool captk::PseudoProgressionPredictionAlgorithm::TrainNewModelOnGivenData(const std::vector<std::map<CAPTK::ImageModalityType, std::string>> qualifiedsubjects, const std::string &outputdirectory, bool useConventionalData, bool useDTIData, bool usePerfData, bool useDistData)
{
...
int captk::PseudoProgressionPredictionAlgorithm::GetFeatureVectorSize(bool &useConventionalData, bool &useDTIData, bool &usePerfData, bool &useDistData)
{
  int size = 0;
...
bool captk::PseudoProgressionPredictionAlgorithm::PseudoProgressionEstimateOnExistingModel(std::vector<std::map<CAPTK::ImageModalityType, std::string>> qualifiedsubjects,
...
VariableLengthVectorType captk::PseudoProgressionPredictionAlgorithm::DistanceFunction(const VariableSizeMatrixType &testData, const std::string &filename, const double &rho, const double &bestg)
{
...
VariableSizeMatrixType captk::PseudoProgressionPredictionAlgorithm::LoadPseudoProgressionTestingData(const std::vector<std::map<CAPTK::ImageModalityType, std::string>> &testingsubjects, std::vector<double> &testinglabels, std::string outputdirectory, std::string modeldirectory)
{
...
VariableSizeMatrixType captk::PseudoProgressionPredictionAlgorithm::LoadPseudoProgressionTrainingData(const std::vector<std::map<CAPTK::ImageModalityType, std::string>> &trainingsubjects, std::vector<double> &traininglabels, std::string outputdirectory)
{
  VariableSizeMatrixType FeaturesOfAllSubjects;
...
PerfusionMapType captk::PseudoProgressionPredictionAlgorithm::CombineAndCalculatePerfusionPCA(PerfusionMapType PerfusionDataMap, VariableSizeMatrixType &TransformationMatrix, VariableLengthVectorType &MeanVector)
{
...
PerfusionMapType captk::PseudoProgressionPredictionAlgorithm::CombineAndCalculatePerfusionPCAForTestData(PerfusionMapType PerfusionDataMap, VariableSizeMatrixType &TransformationMatrix, VariableLengthVectorType &MeanVector)
{
  PerfusionMapType RevisedPerfusionMap;
...
PerfusionMapType captk::PseudoProgressionPredictionAlgorithm::CombinePerfusionDataAndApplyExistingPerfusionModel(PerfusionMapType PerfusionDataMap, VariableSizeMatrixType TransformationMatrix, VariableLengthVectorType MeanVector)
{
  PerfusionMapType RevisedPerfusionMap;
...
VectorDouble captk::PseudoProgressionPredictionAlgorithm::GetIntensityFeatures(std::vector<float> m_nonZeroPixels)
{
...
VectorDouble captk::PseudoProgressionPredictionAlgorithm::GetHistogramFeatures(std::vector<float> intensities, int m_Bins)
{
  std::vector<double> features;
...
VectorDouble captk::PseudoProgressionPredictionAlgorithm::GetHistogramFeaturesWhole(std::vector<float> intensities)
{
...
VectorVectorDouble captk::PseudoProgressionPredictionAlgorithm::CombineAllThePerfusionFeaures(VectorVectorDouble T1IntensityHistogram,
  VectorVectorDouble TCIntensityHistogram,
  VectorVectorDouble T1TCIntensityHistogram,
  VectorVectorDouble T2IntensityHistogram,
  VectorVectorDouble FLIntensityHistogram,
...
VariableSizeMatrixType captk::PseudoProgressionPredictionAlgorithm::ColumnWiseScaling(VariableSizeMatrixType inputdata)
{
...
VariableSizeMatrixType captk::PseudoProgressionPredictionAlgorithm::SelectModelFeatures(const VariableSizeMatrixType &ModelFeatures)
{
...
VectorDouble captk::PseudoProgressionPredictionAlgorithm::EffectSizeFeatureSelection(const VariableSizeMatrixType training_features, std::vector<double> target)
{
  //make set 1and set2
  int NoOfSamplesC1 = 0;
  int NoOfSamplesC2 = 0;
...
template <typename T>
std::vector<size_t> captk::PseudoProgressionPredictionAlgorithm::sort_indexes(const std::vector<T> &v)
{
...
VectorDouble captk::PseudoProgressionPredictionAlgorithm::CombineEstimates(const VariableLengthVectorType &estimates1, const VariableLengthVectorType &estimates2)
{
...
void captk::PseudoProgressionPredictionAlgorithm::WritePCAOutputs(std::string suffix, std::string outputdirectory, const VariableLengthVectorType mean, const VariableSizeMatrixType coefs)
{
  std::ofstream myfile;
...
void captk::PseudoProgressionPredictionAlgorithm::ReadAllTheModelParameters(std::string modeldirectory,
  VariableSizeMatrixType &PCA_PERF,
  VariableSizeMatrixType &PCA_T1,
  VariableSizeMatrixType &PCA_T1CE,
  VariableSizeMatrixType &PCA_T2,
...
void captk::PseudoProgressionPredictionAlgorithm::WriteCSVFiles(VariableSizeMatrixType inputdata, std::string filepath)
{
  std::ofstream myfile;
...
void captk::PseudoProgressionPredictionAlgorithm::WriteCSVFiles(VectorVectorDouble inputdata, std::string filepath)
{
  std::ofstream myfile;
  myfile.open(filepath);
...
void captk::PseudoProgressionPredictionAlgorithm::WriteCSVFiles(vtkSmartPointer<vtkTable> inputdata, std::string filepath)
{
  std::ofstream myfile;
  myfile.open(filepath);
...
void captk::PseudoProgressionPredictionAlgorithm::WriteCSVFiles(VariableLengthVectorType inputdata, std::string filepath)
{
  std::ofstream myfile;
  myfile.open(filepath);
  for (unsigned int index1 = 0; index1 < inputdata.Size(); index1++)
...
void captk::PseudoProgressionPredictionAlgorithm::WriteCSVFiles(std::vector<double> inputdata, std::string filepath)
{
  std::ofstream myfile;
  myfile.open(filepath);
  for (unsigned int index1 = 0; index1 < inputdata.size(); index1++)
...
VariableSizeMatrixType captk::PseudoProgressionPredictionAlgorithm::GetModelSelectedFeatures(VariableSizeMatrixType & ScaledFeatureSetAfterAddingLabel, VariableLengthVectorType & SelectedFeatures)
{
...
vtkSmartPointer<vtkTable> captk::PseudoProgressionPredictionAlgorithm::MakePCAMatrix(int NumberOfFeatures, int NumberOfSamples)
{
