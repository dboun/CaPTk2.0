/**
\file PseudoProgressionPredictionAlgorithm.h

This file holds the declaration of the class PseudoProgressionPredictionAlgorithm.
...
#ifndef _PseudoProgressionPredictionAlgorithm_h_
#define _PseudoProgressionPredictionAlgorithm_h_
...
#include <MitkCaPTkPseudoProgressionExports.h>
...
{
/**
\class PseudoProgressionPredictionAlgorithm
\brief A small description of PseudoProgressionPredictionAlgorithm
...
*/
class MITKCAPTKPSEUDOPROGRESSION_EXPORT PseudoProgressionPredictionAlgorithm
{
public:
  /**
  \brief Default Constructor
  */
  PseudoProgressionPredictionAlgorithm()
  {
...
template<class ImageType>
void PseudoProgressionPredictionAlgorithm::PseudoProgressionEstimateOnGivenSubject(typename ImageType::Pointer edemaMask,
  typename ImageType::Pointer tumorMask,
  typename ImageType::Pointer FinalT1CEImagePointer,
  typename ImageType::Pointer FinalT2FlairImagePointer,
  typename ImageType::Pointer FinalT1ImagePointer,
...
template<class ImageType>
void PseudoProgressionPredictionAlgorithm::PseudoProgressionEstimateOnGivenSubjectUsingExistingModel(typename ImageType::Pointer edemaMask,
  typename ImageType::Pointer tumorMask,
  typename ImageType::Pointer FinalT1CEImagePointer,
  typename ImageType::Pointer FinalT2FlairImagePointer,
  typename ImageType::Pointer FinalT1ImagePointer,
...
template<class ImageType>
typename ImageType::Pointer PseudoProgressionPredictionAlgorithm::RescaleImageIntensity(const typename ImageType::Pointer &image)
{
...
template <class ImageType>
typename ImageType::Pointer PseudoProgressionPredictionAlgorithm::ReadNiftiImage(const std::string &filename)
{
...
template<class ImageType>
VectorDouble PseudoProgressionPredictionAlgorithm::RecurrenceMapPostprocessing(VectorDouble result, std::vector<typename ImageType::IndexType> testindices, typename ImageType::Pointer RecurrenceProbabilityMap, typename ImageType::Pointer edemaMap)
{
...
template<class PerfusionImageType, class ImageType>
VariableSizeMatrixType PseudoProgressionPredictionAlgorithm::LoadPerfusionData(typename ImageType::Pointer maskImagePointerNifti, typename PerfusionImageType::Pointer perfImagePointerNifti, std::vector<typename ImageType::IndexType> &qualifiedIndices)
{
...
template<class ImageType>
std::tuple<VectorDouble, VectorDouble, VectorDouble, VectorDouble, VectorDouble> PseudoProgressionPredictionAlgorithm::GetAllFeaturesPerImagePerROI(typename ImageType::Pointer image, typename ImageType::Pointer mask, std::string modality)
{
...
VectorDouble PseudoProgressionPredictionAlgorithm::GetShapeFeatures(typename TImageTypeShape::Pointer mask)
{
...
template<class ImageType>
VectorDouble PseudoProgressionPredictionAlgorithm::GetGLCMFeatures(typename ImageType::Pointer image, typename ImageType::Pointer mask, double minvalue, double maxvalue)
{
  double m_Bins = 16;
...
template<class ImageType>
VectorDouble PseudoProgressionPredictionAlgorithm::GetRunLengthFeatures(typename ImageType::Pointer image, typename ImageType::Pointer mask, double minvalue, double maxvalue)
{
  double m_Bins = 16;
...
template<class ImageType>
typename ImageType::Pointer PseudoProgressionPredictionAlgorithm::MakeAdditionalModality(typename ImageType::Pointer image1, typename ImageType::Pointer image2)
{
