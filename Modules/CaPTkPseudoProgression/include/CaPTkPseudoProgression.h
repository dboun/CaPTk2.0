#ifndef CaPTkPseudoProgression_h
#define CaPTkPseudoProgression_h
...
namespace captk {
/** \class CaPTkPseudoProgression
 *  \brief PseudoProgression Prediction Index Module API
 */
class MITKCAPTKPSEUDOPROGRESSION_EXPORT CaPTkPseudoProgression : public QObject
{
    Q_OBJECT

public:
    CaPTkPseudoProgression(QObject *parent = 0);
...
#endif // ! CaPTkPseudoProgression_h
