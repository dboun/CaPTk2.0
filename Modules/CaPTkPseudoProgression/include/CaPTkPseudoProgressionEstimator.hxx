...
void captk::PseudoProgressionEstimator::PseudoProgressionEstimateOnGivenSubject(
...
template <class ImageType>
void captk::PseudoProgressionEstimator::PseudoProgressionEstimateOnGivenSubjectUsingExistingModel(
    typename ImageType::Pointer edemaMask,
    typename ImageType::Pointer tumorMask,
    typename ImageType::Pointer FinalT1CEImagePointer,
    typename ImageType::Pointer FinalT2FlairImagePointer,
...
captk::PseudoProgressionEstimator::RescaleImageIntensity(const typename ImageType::Pointer &image)
{
...
template <class ImageType>
typename ImageType::Pointer 
captk::PseudoProgressionEstimator::ReadNiftiImage(const std::string &filename)
{
...
template <class ImageType>
VectorDouble captk::PseudoProgressionEstimator::RecurrenceMapPostprocessing(
    VectorDouble result, 
    std::vector<typename ImageType::IndexType> testindices, 
...
VariableSizeMatrixType captk::PseudoProgressionEstimator::LoadPerfusionData(
    typename ImageType::Pointer maskImagePointerNifti, 
    typename PerfusionImageType::Pointer perfImagePointerNifti, 
    std::vector<typename ImageType::IndexType> &qualifiedIndices)
{
...
captk::PseudoProgressionEstimator::GetAllFeaturesPerImagePerROI(
...
VectorDouble captk::PseudoProgressionEstimator::GetShapeFeatures(typename TImageTypeShape::Pointer mask)
{
...
template <class ImageType>
VectorDouble captk::PseudoProgressionEstimator::GetGLCMFeatures(
    typename ImageType::Pointer image, 
    typename ImageType::Pointer mask, 
    double minvalue, 
    double maxvalue)
...
template <class ImageType>
VectorDouble captk::PseudoProgressionEstimator::GetRunLengthFeatures(
    typename ImageType::Pointer image, 
    typename ImageType::Pointer mask, 
    double minvalue, 
    double maxvalue)
...
template <class ImageType>
typename ImageType::Pointer 
captk::PseudoProgressionEstimator::MakeAdditionalModality(
